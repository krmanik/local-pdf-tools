      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="card mt-12">
          ...
          <ul className="space-y-2 text-muted-600 dark:text-muted-300 mb-6">
            ...
            <li className="flex items-start gap-2">
              <span className="text-primary-600 dark:text-primary-400 font-bold">•</span>
              <span><strong className="text-gray-900 dark:text-white">Custom Commands:</strong> {t('customCommandsFeature')}</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary-600 dark:text-primary-400 font-bold">•</span>
              <span><strong className="text-gray-900 dark:text-white">Terminal Output:</strong> {t('terminalOutputFeature')}</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary-600 dark:text-primary-400 font-bold">•</span>
